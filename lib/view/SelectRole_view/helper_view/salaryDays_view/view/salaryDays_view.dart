...
import 'currentSalary_view.dart';


class SalaryDaysView extends StatelessWidget {
  const SalaryDaysView({super.key});
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(AppImages.salaryDays),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
