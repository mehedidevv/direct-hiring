...
import 'package:direct_hiring/view/SelectRole_view/helper_view/question_view/view/questionnaire_view.dart';
...
class ReligionView extends StatefulWidget {
  ReligionView({super.key});

  @override
  State<ReligionView> createState() => _famillyMemberslViewState();
}

class _famillyMemberslViewState extends State<ReligionView> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              heightBox30,
              CustomText(
                title: 'What\'s your religion? (Choose only 1 option)*',
                fontSize: 16,
